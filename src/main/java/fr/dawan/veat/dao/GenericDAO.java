...
public class GenericDAO {
	...
	/**
	 * Permet de récupérer toutes les entrées pour une table données à partir d'une entrée, pour un nombre de résultat donné
	...
	public static <T extends DbObject> List<T> findAll(Class<T> clazz, int begin, int nbResult) {
		...
		resultat = query
				.setFirstResult(begin)// On commence à ce numéro(begin)
